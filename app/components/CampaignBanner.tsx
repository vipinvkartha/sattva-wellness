...
export default function CampaignBanner() {
  return (
    <div className="fixed top-0 left-0 right-0 z-[101] bg-gradient-to-r from-teal-600 to-emerald-600 text-white text-sm py-2 px-4">
      <div className="max-w-7xl mx-auto flex justify-center items-center gap-4 flex-wrap">
        ...
        <div className="flex items-center gap-4">
          ...
          <span className="font-medium">+91 9895798155</span>
        </div>
      </div>
    </div>
  );
