...
function FeatureCard({ icon, title, description }: FeatureCardProps) {
  return (
    <Card
      className="group relative flex flex-col items-center p-6 text-center transition-all duration-500 
    ...
    >
      <div
        className="relative rounded-full bg-gradient-to-br from-teal-50 to-white dark:from-teal-900 dark:to-teal-800 
      ...
      <h3
        className="mt-4 text-xl font-semibold text-teal-900 dark:text-teal-100 transition-colors
        group-hover:text-teal-800 dark:group-hover:text-white"
      >
        {title}
      </h3>
      <p
        className="mt-2 text-teal-700 dark:text-teal-300 transition-colors
              ...
              {[...Array(5)].map((_, i) => {
                ...
                return (
                  <svg
                    ...
                    viewBox="0 0 24 24"
                    fill={
                      ratingDiff > 0 && ratingDiff < 1 ? "currentColor" : "none"
                    }
                  >
                    <path
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-teal-50 via-emerald-50/50 to-teal-50 dark:from-teal-950 dark:via-emerald-950/50 dark:to-teal-950">
      ...
      <section
        id="home"
        className="relative px-4 pt-36 pb-16 sm:px-6 lg:px-8 lg:pt-48 overflow-hidden"
      >
        ...
        <div
          className="absolute inset-0 bg-gradient-to-r from-transparent via-teal-100/30 to-transparent 
          animate-[shine_3s_ease-in-out_infinite] dark:via-teal-800/10"
        ></div>

        <div className="relative mx-auto max-w-7xl text-center">
          <h1 className="text-4xl font-bold tracking-tight sm:text-6xl animate-fade-in">
            <span
              className="inline-block bg-gradient-to-r from-teal-700 via-emerald-600 to-teal-700 
          ...
          <p
            className="mt-2 text-lg italic text-teal-600/80 dark:text-teal-400/80 
          ...
          <p
            className="mx-auto mt-6 max-w-2xl text-lg text-teal-700/90 dark:text-teal-300/90
            drop-shadow-sm"
          >
            Discover a holistic approach to health and wellness. Our program
            combines mindfulness, nutrition, and movement to help you achieve
            lasting balance and vitality.
          </p>
        </div>
      </section>
      ...
      <section
        id="why-yoga"
        className="py-16 bg-gradient-to-br from-teal-50/50 via-white to-teal-50/50 
      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              <div
                className="h-12 w-12 rounded-full bg-teal-100 dark:bg-teal-900 flex items-center justify-center mb-4
          ...
          <div className="mt-12 text-center">
            <p className="text-lg text-teal-700 dark:text-teal-300 mb-6 max-w-2xl mx-auto">
              Experience these transformative benefits firsthand. Join our yoga
              community and begin your journey towards holistic well-being.
            </p>
            <a
      ...
      <section
        id="gallery"
        className="py-16 bg-gradient-to-b from-transparent via-teal-50/50 to-transparent dark:via-teal-950/30"
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-12">
            <button
              onClick={() =>
                window.open(
                  "https://www.instagram.com/sattva_wellness_?igsh=eXplaW01M3VxaXpn",
                  "_blank"
                )
              }
              className="inline-flex items-center px-6 py-3 text-base font-medium text-white 
      ...
      <section
        id="testimonials"
        className="py-16 bg-gradient-to-br from-white to-teal-50/30 
      ...
      <section
        id="contact"
        className="bg-gradient-to-br from-teal-900 to-slate-900 dark:from-slate-900 dark:to-black py-16"
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl bg-white/10 backdrop-blur-lg p-8 shadow-lg sm:p-12">
            <div className="text-center">
              ...
              <p className="mx-auto mt-4 max-w-2xl text-slate-300">
                Join our community of mindful individuals committed to living
                their best lives. Start your transformation with a free
                consultation.
              </p>
              <a
                href="https://forms.zohopublic.eu/sattva/form/SattvaWellnessRegistrationForm/formperma/uESkDIJRLWFDFCpd6VWeBhSa5TEBQEBLsUVnG1JVayI"
          ...
          <div className="flex flex-col items-center justify-center space-y-4 sm:space-y-6">
            ...
            <div className="pt-4 border-t border-teal-800 w-full text-center">
              <p className="text-sm text-teal-300">
                © {new Date().getFullYear()} Sattva Wellness. All rights
                reserved.
              </p>
